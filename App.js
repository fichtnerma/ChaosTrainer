...
import PolizeiScreen from "./app/screens/SosUnterseiten/PolizeiScreen";
import GiftScreen from "./app/screens/SosUnterseiten/GiftScreen";
import FeuerwehrScreen from "./app/screens/SosUnterseiten/FeuerwehrScreen";
...
function SosStack() {
  return (
    <Stack.Navigator screenOptions={headerStyle}>
      ...
      <Stack.Screen name="Polizei" component={PolizeiScreen} />
      <Stack.Screen name="Gift" component={GiftScreen} />
      <Stack.Screen name="Feuerwehr" component={FeuerwehrScreen} />
    </Stack.Navigator>
  );
}
  ...
  return (
    <Stack.Navigator screenOptions={headerStyle}>
      ...
      <Stack.Screen
        ...
        component={AkuteErkrankungenScreen}
      />
