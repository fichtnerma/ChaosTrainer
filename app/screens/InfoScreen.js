    ...
    return (
        <View style={mainStyle.container}>
            <View style={infoStyle.layout}>
                ...
                <TouchableOpacity
                    style={[mainStyle.iconBox, infoStyle.boxSize]}
                    onPress={() => navigation.navigate("ErsteHilfe", {page: "brand"})}
                >
                    <Image
            ...
            <View style={infoStyle.layout}>
                <TouchableOpacity
                    style={[mainStyle.iconBox, infoStyle.boxSize]}
                    onPress={() => navigation.navigate("ErsteHilfe", {page: "virus"})}
                >
                    <Image
                ...
                <TouchableOpacity
                    style={[mainStyle.iconBox, infoStyle.boxSize]}
                    onPress={() => navigation.navigate("ErsteHilfe", {page: "unfall"})}
                >
                    <Image
            ...
            <View style={infoStyle.layout}>
                ...
                >
                    <Image
                        source={require("../assets/InfoScreen/Ueberschwemmung.png")}
                        style={mainStyle.icons}
                    />
                ...
                <TouchableOpacity
                    style={[mainStyle.iconBox, infoStyle.boxSize]}
                    onPress={() => navigation.navigate("ErsteHilfe", {page: "terror"})}
                >
                    <Image
