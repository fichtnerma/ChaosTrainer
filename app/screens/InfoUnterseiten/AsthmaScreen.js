        ...
        <View style={styles.container}>
            ...
            <View style={kacheln.infoBox}>
                <ScrollView style={{marginBottom: 10}}>
                    <Text style={kacheln.h2}>{data.name}</Text>
                    <Text style={kacheln.infoText}>{data.cause}</Text>
                    <Text style={kacheln.h2}>ERKENNEN</Text>
                    <Text style={kacheln.infoText}>
                        • Mühe beim Lufteinatmen, das Ausatmen fällt ihm schwer{' '}
                    </Text>
                    <Text style={kacheln.infoText}>
                        • Betroffene ringt keuchend nach Luft - infolge des
                        Sauerstoffmangels blau im Gesicht (besonders an den
                        Lippen erkennbar){' '}
                    </Text>
                    <Text style={kacheln.infoText}>
                        • Betroffener hat Angst und ist sehr unruhig{' '}
                    </Text>
                    <Text style={kacheln.h2}>MAßNAHMEN</Text>
                    <Text style={kacheln.infoText}>
                        • Betroffenen beruhigen und ihn auffordern, bei
                        aufrechtem Oberkörper (stehend oder sitzend) ruhig zu
                        atmen{' '}
                    </Text>
                    <Text style={kacheln.infoText}>
                        • Einnahme von Medikamenten (Inhalation) unterstützen{' '}
                    </Text>
                    <Text style={kacheln.infoText}>
