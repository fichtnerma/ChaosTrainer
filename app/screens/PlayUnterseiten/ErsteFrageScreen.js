...
export default class ErsteFrageHomeScreen extends Component {
  ...
  cutArray(array) {
    const { Settings } = this.props.route.params;
    let anzahl =
      Settings.anzahl < array.length ? Settings.anzahl : array.length;
  ...
  getStyle(index) {
    if (index == this.state.clicked) {
      if (this.state.buttonClicked == true) {
        if (
          this.state.questionData[this.state.counter].Antworten[index]
            .antwort[1] == true
        ) {
                ...
                <>
                  ...
                  >
                    <Text style={styles.antwortText}>
                      A:{" "}
                      {
                        this.state.questionData[this.state.counter].Antworten[0]
                          .antwort
                      }
                    </Text>
                  </TouchableWithoutFeedback>
                  ...
                  >
                    <Text style={styles.antwortText}>
                      B:{" "}
                      {
                        this.state.questionData[this.state.counter].Antworten[1]
                          .antwort
                      }
                    </Text>
                  </TouchableWithoutFeedback>
                  ...
                  >
                    <Text style={styles.antwortText}>
                      C:{" "}
                      {
                        this.state.questionData[this.state.counter].Antworten[2]
                          .antwort
                      }
                    </Text>
                  </TouchableWithoutFeedback>
                  ...
                  >
                    <Text style={styles.antwortText}>
                      D:{" "}
                      {
                        this.state.questionData[this.state.counter].Antworten[3]
                          .antwort
                      }
                    </Text>
                  </TouchableWithoutFeedback>{" "}
