...
export default function PolizeiScreen({ navigation }) {
  const triggerCall = () => {
    const args = {
  ...
  return (
    <View style={sosUnterseiteStyle.container}>
      <View style={sosUnterseiteStyle.rufnummerBox}>
        <Text style={sosUnterseiteStyle.h1}>Polizei</Text>
        <Text style={sosUnterseiteStyle.nummerText}>110</Text>
        <TouchableOpacity
          style={sosUnterseiteStyle.telefonButton}
          onPress={triggerCall}
        >
          <Image
